...
@Component({
  selector: 'app-personaDoc',
  templateUrl: './personaDoc.component.html',
  styleUrls: ['./personaDoc.component.scss']
})
export class PersonaDocComponent implements OnInit {
